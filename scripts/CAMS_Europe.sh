...
# SO2
python main.py --input_file /home/earajr/convert2GEOJSON/convert2GeoJSON/testdata/CAMS_europe/CAMS_Europe_20250820_00_0_72_0000.nc --output_dir ../testdata_output/CAMS_europe/. --var_name so2_conc --source CAMS_europe --contour_thresholds 0.0 0.177 0.316 0.562 1.0 1.77 3.16 5.62 10.0 17.7 31.6 56.2 100.0 177.0 316.0 562.0 1000.0 --simplify --parallel --smooth --sigma 1

python main.py --input_file /home/earajr/convert2GEOJSON/convert2GeoJSON/testdata/CAMS_europe/CAMS_Europe_20250820_00_0_72_0000.nc --output_dir ../testdata_output/CAMS_europe/. --var_name so2_conc --source CAMS_europe --contour_thresholds 0.0 100.0 200.0 350.0 500.0 750.0 1250.0 10000.0 --simplify --parallel --smooth --sigma 1
